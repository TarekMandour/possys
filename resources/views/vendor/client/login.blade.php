        ...
        <div class="wrapper-page">
            <div class="card">
                <div class="card-body" dir="rtl">
                    ...
                    <a href="/client/login" class="logo logo-admin"><img src="{{ url('public/uploads/posts')}}/{{ $Settings->logo1 }}" height="100" alt="{{ $Settings->title }}"></a> 
                    ...
                    <div class="p-3">
                        ...
                        @endif
                        <form class="form-horizontal m-t-30" method="POST" action="{{ route('client.login.submit') }}">
