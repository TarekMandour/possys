                    ...
                    <form action="{{ route('admin.edit_setting.submit') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">الوصف en</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group text-center">
                                            ...
                                            <br>
                                            @if ($data->fav == Null)
                                                <img class="img-thumbnail" id="get_photo_link3" style="width: 200px;" src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" data-holder-rendered="true">
                                            @else  
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group text-center">
                                            ...
                                            @if ($data->breadcrumb == Null)
                                                <img class="img-thumbnail" id="get_photo_link4" style="width: 200px;" src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" data-holder-rendered="true">
                                            @else  
