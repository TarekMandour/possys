        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="m-b-30">
                        <a href="{{ url('/admin/create_setting/') }}" class="btn btn-purple waves-effect waves-light" role="button">اضف جديد</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($row->photo == Null)
                                        ---
                                    @else
                                        <a class="image-popup-no-margins" title="{{$row->photo}}" href="{{ URL::asset('public/uploads/posts') }}/{{$row->photo}}"><div class="img-responsive">
                                            <img src="{{ URL::asset('public/uploads/posts') }}/{{$row->photo}}" width="45">
                                        </div></a>
                                    @endif
                                </td>
                                <td>{{$row->title}}</td>
                                ...
                                <td>
                                    <a href="{{ url('/admin/show_setting/'.$row->id) }}" class="btn btn-purple btn-sm waves-effect waves-light"><i class="ti-eye"></i></a>
                                    <a href="{{ url('/admin/edit_setting/'.$row->id) }}" class="btn btn-info btn-sm waves-effect waves-light"><i class="ti-pencil-alt"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        if (checkIDs.length > 0) {
            ...
            Swal.fire({
                ...
                if (isConfirm.value) {
                    $.ajax(
                    {
                        url: "{{route('admin.delete_setting')}}",
                        type: 'post',
                        dataType: "JSON",
                        data: {
                            "id": checkIDs,
