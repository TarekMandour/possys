						...
						<div class="col-sm-8">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="text-left"><strong>العنوان 2 :</strong></td>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="p-2">
                                                <a href="{{ url('/admin/edit_slider/'.$data->id) }}" class="btn btn-outline-purple waves-effect waves-light">تعديل الحساب</a>
                                            </div></td>
