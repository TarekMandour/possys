...
@section('breadcrumb')
<h3 class="page-title">الصفحات</h1>
@endsection
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">العنوان</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{ $data->home_title }}" name="home_title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-4 col-form-label">المحتوى</label>
                                            <div class="col-sm-12">
                                                <textarea id="textarea" class="form-control summernote" name="home_content">{{$data->home_content}}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{ $data->home_title_en }}" name="home_title_en">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea id="textarea" class="form-control summernote" name="home_content_en">{{$data->home_content_en}}</textarea>
                                            </div>
                                        </div>
