						...
						<div class="col-sm-8">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="text-left" style="width: 30%;"><strong>العنوان :</strong></td>
                                        <td class="text-center"><?php echo $data->title ; ?></td>
                                   </tr>
                                   <tr>
                                        <td class="text-left" style="width: 30%;"><strong>القسـم :</strong></td>
                                        <td class="text-center"><?php echo $data->category->title ; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="p-2">
                                                <a href="{{ url('/admin/edit_post/'.$data->id) }}" class="btn btn-outline-purple waves-effect waves-light">تعديل البيانات</a>
                                            </div></td>
