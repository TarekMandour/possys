...
@section('breadcrumb')
<h3 class="page-title">الخصائص</h1>
@endsection
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_attribute.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
        ...
        if (checkIDs.length > 0) {
            ...
            Swal.fire({
                ...
                if (isConfirm.value) {
                    $.ajax(
                    {
                        url: "{{route('admin.delete_attribute')}}",
                        type: 'post',
                        dataType: "JSON",
                        data: {
                            "id": checkIDs,
