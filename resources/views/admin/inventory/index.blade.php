        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="m-b-30">
                        <a href="{{ url('/admin/create_admin/') }}" class="btn btn-purple waves-effect waves-light"
                           data-toggle="modal" data-target="#addModel" role="button">اضف جديد</a>
                    ...
                    <table id="datatable" class="table table-striped table-bordered dt-responsive" cellspacing="0"
                        ...
                        @foreach ($data as $item=>$row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('admin/inventory/'.$row->id)}}" class="btn btn-info btn-sm waves-effect waves-light"><i
                                            class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ url('admin/create_inventory') }}"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">اسم الجرد</label>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control select2" name="branch_id">
                                                @foreach (\App\Models\Branch::all() as $item=>$row)
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                            {
                                url: "{{route('admin.delete_inventory')}}",
                                type: 'post',
                                dataType: "JSON",
                                data: {
                                    "id": checkIDs,
