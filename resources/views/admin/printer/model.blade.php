...
<form action="{{ route('admin.update_printer.submit') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <label for="example-text-input" class="col-sm-12 col-form-label">اسم الوحدة</label>
                <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input class="form-control" type="text" value="{{ $data->ip }}" name="ip" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input class="form-control" type="text" value="{{ $data->port }}" name="port" required>
                </div>
            </div>
