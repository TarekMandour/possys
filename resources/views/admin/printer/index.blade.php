...
@section('breadcrumb')
<h3 class="page-title">الطابعات</h1>
@endsection
            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="m-b-30">
                        ...
                        <a href="javascript:;" class="btn btn-purple waves-effect waves-light" data-toggle="modal" data-target="#addModel" role="button">اضف جديد</a>
                        @endcan
                        @can('حذف الطابعات')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_printer.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">

                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">اسم الطابعة</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">Ip </label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="" name="ip" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">Port</label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" value="" name="port" required>
                                    </div>
                                </div>
        ...
        if (checkIDs.length > 0) {
            ...
            Swal.fire({
                ...
                if (isConfirm.value) {
                    $.ajax(
                    {
                        url: "{{route('admin.delete_printer')}}",
                        type: 'post',
                        dataType: "JSON",
                        data: {
                            "id": checkIDs,
