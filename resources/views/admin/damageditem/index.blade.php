...
@section('breadcrumb')
<h3 class="page-title">مستودع الاصناف التالفة</h1>
@endsection
        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    <div class="">
                        ...
                        <form action="{{ route('admin.filter_damageditem.submit') }}" id="fillter-branches"
                              method="get">
                            @csrf
                            <div class="row">
            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <div class="m-b-30">
                        @can('اضافة الاصناف التالفة')

                        <a href="{{ url('/admin/create_damageditem/') }}" class="btn btn-purple waves-effect waves-light" data-toggle="modal" data-target="#addModel" role="button">اضف جديد</a>
                        @endcan
                        @can('حذف الاصناف التالفة')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_damageditem.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">الكمية </label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">تاريخ التلف</label>
                                    <div class="col-sm-12">
        ...
        if (checkIDs.length > 0) {
            ...
            Swal.fire({
                ...
                if (isConfirm.value) {
                    $.ajax(
                    {
                        url: "{{route('admin.delete_damageditem')}}",
                        type: 'post',
                        dataType: "JSON",
                        data: {
                            "id": checkIDs,
