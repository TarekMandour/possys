...
@section('breadcrumb')
<h3 class="page-title">فئات الطاولات</h1>
@endsection
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_tablecat.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
        ...
        if (checkIDs.length > 0) {
            ...
            Swal.fire({
                ...
                if (isConfirm.value) {
                    $.ajax(
                    {
                        url: "{{route('admin.delete_tablecat')}}",
                        type: 'post',
                        dataType: "JSON",
                        data: {
                            "id": checkIDs,
