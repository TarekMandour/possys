...
@section('breadcrumb')
<h3 class="page-title">الاقسام</h1>
@endsection
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($row->photo == Null)
                                        ---
                                    @else
                                        <a class="image-popup-no-margins" title="{{$row->photo}}" href="{{$row->photo}}"><div class="img-responsive">
                                            <img src="{{$row->photo}}" width="45">
                                        </div></a>
                                    @endif
                                </td>
                                <td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_category.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
