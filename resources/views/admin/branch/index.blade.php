                                ...
                                @foreach ($data as $item=>$row)
                                    <tr>
                                        ...
                                        @if ($row->location != null)
                                            <td><a href="{{$row->location}}" target="_blank">عرض</a></td>
                                        @else
                                            <td>---</td>
                                        @endif
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" dir="rtl">
                            ...
                            <form method="post" action="{{ route('admin.create_branch.submit') }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">الموقع على
                                                الخريطة</label>
                                            <div class="col-sm-12">
