        ...
        <div class="container-fluid" dir="rtl">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.edit_contact.submit') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea id="textarea" class="form-control summernote" name="msg">{{$data->msg}}</textarea>
                                    </div>
                                </div>
                            </div>
