        ...
        <div class="wrapper-page">
            <div class="card">
                <div class="card-body" dir="rtl">
                    ...
                    <a href="/admin/login" class="logo logo-admin"><img src="{{ url('public/uploads/posts')}}/{{ $Settings->logo2 }}" height="100" alt="{{ $Settings->title }}"></a> 
            ...
            <div class="m-t-40 text-center">
                <p class="text-dark">© {{date('Y')}} {{ $Settings->title }},<br> Crafted with <i class="mdi mdi-heart text-danger"></i> by EXAS2030</p>
            </div>
