                                ...
                                <div class="col-sm-6">
                                        ...
                                        <h3 class="panel-title font-20">
                                            @if ($data->photo != NULL)
                                                <a class="image-popup-vertical-fit"
                                                   href="{{ URL::asset('public/uploads/') }}/{{$data->photo}}"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td class="text-left"><strong>النوع :</strong></td>
                                            ...
                                            <tr style="@if(!$data->Branch) display: none @endif">
                                                <td class="text-left"><strong>الفرع :</strong></td>
                                                <td class="text-center">@if($data->Branch)  {{$data->Branch->name}} @endif</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="text-left">
                                                    <div class="p-2">
                                                        <a href="{{ url('/admin/edit_admin/'.$data->id) }}"
                                                           class="btn btn-outline-purple waves-effect waves-light">تعديل
                                                            الحساب</a>
                                                    </div>
                                                </td>
