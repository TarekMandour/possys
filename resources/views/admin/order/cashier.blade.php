...
@section('breadcrumb')
    <h1 class="page-title">فاتورة مبيعات</h1>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control" name="client_phone" type="text"
                                       value="1"
                                       placeholder="جوال العميل" id="client_phone">
                            ...
                            @endif
                            <div class="col-sm-3">
                                <input class="form-control" type="datetime-local" value="{{date('Y-m-d\TH:i')}}"
                                       name="sdate" required>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                <div class="row m-b-10">
                                    ...
                                    <div class="col-sm-3">
                                        <small class="form-text text-muted">نوع الخصم</small>
                                        <select class="form-control" id="discount" name="discount">
                                            <option value="">----</option>
                                            @foreach (\App\Models\Discounts::get() as $discount)
                                                <option discount="{{$discount->id}}" value="{{$discount->id}}">{{$discount->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
...
@section('script-bottom')
    ...
    <script>
        ...
        $('#discount').change(function () {
            var $select = $('#discount');
            var discount = $('option:selected', $select).attr('discount');

            $.ajax({
                type: "GET",
                url: "{{url('admin/add_discount')}}",
