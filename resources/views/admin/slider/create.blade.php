                ...
                <div class="container-fluid" dir="rtl">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.create_slider.submit') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">عنوان
                                                1</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{ old('title1') }}"
                                                       name="title1" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-sm-12 col-form-label">وصف
                                                مصغر</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" value="{{ old('title2') }}"
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input"
                                                   class="col-sm-12 col-form-label">الترتيب</label>
                                            <div class="col-sm-12">
                                                <input class="form-control" type="number" value="{{ old('sort') }}"
                                                       name="sort" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group text-center">
                                            ...
                                            <input type="file" class="filestyle" name="logo" id="photo_link2"
                                                   data-buttonname="btn-secondary">
                                            <br>
                                            <img class="img-thumbnail" id="get_photo_link2" style="width: 200px;"
                                                 src="https://via.placeholder.com/200x150/EFEFEF/AAAAAA&amp;text=no+image/200x150/EFEFEF/AAAAAA&amp;text=no+image"
                                                 data-holder-rendered="true">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="example-text-input"
                                                   class="col-sm-4 col-form-label">المحتوى</label>
                                            <div class="col-sm-12">
