...
<form action="{{ route('admin.update_table.submit') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <select class="form-control" name="status">										
                        <option value="0" @if($data->status == 0) selected @endif>فارغة</option>											
                        <option value="1" @if($data->status == 1) selected @endif>محجوزه</option>											
                        <option value="2" @if($data->status == 2) selected @endif>مشغوله</option>											
                    </select>
                </div>
            </div>
