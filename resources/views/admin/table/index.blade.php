...
@section('breadcrumb')
<h3 class="page-title">الطاولات</h1>
@endsection
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_table.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">

                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">اسم الطاولة</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">الفئات </label>
                                    <div class="col-sm-12">
                                        <select class="form-control" name="cat_id" required="">
                                            <option value="">---</option>
                                            @foreach (App\Models\TableCat::get() as $cat)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="status">										
                                            <option value="0">فارغة</option>											
                                            <option value="1">محجوزه</option>											
                                            <option value="2">مشغوله</option>											
                                        </select>
                                    </div>
                                </div>
