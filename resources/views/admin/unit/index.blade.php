...
@section('breadcrumb')
<h3 class="page-title">الوحدات</h1>
@endsection
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_unit.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">رقم الوحدة</label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="number" value="" name="num" required>
                                    </div>
                                </div>
