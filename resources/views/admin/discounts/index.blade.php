...
@section('breadcrumb')
<h3 class="page-title">الخصومات</h1>
@endsection
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" dir="rtl">
                    ...
                    <form method="post" action="{{ route('admin.create_discount.submit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">الخصم</label>
                                    <div class="col-sm-12">
                                        <input class="form-control" type="number" value="" name="discount" required>
                                    </div>
                                </div>
        ...
        if (checkIDs.length > 0) {
            ...
            Swal.fire({
                ...
                if (isConfirm.value) {
                    $.ajax(
                    {
                        url: "{{route('admin.delete_discount')}}",
                        type: 'post',
                        dataType: "JSON",
                        data: {
                            "id": checkIDs,
