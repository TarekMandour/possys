...
<form action="{{ route('admin.update_discount.submit') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <input class="form-control" type="number" value="{{ $data->discount }}" name="discount" required>
                </div>
            </div>
